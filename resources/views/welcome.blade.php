...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-black">
        ...
        <nav class="bg-black p-4">
            <div class="container mx-auto">
                <div class="flex justify-between items-center">
                    <a href="#" class="text-white text-xl font-bold">MHenriquez</a>
        ...
        <div class="container mx-auto p-4 mt-4 text-white">
            <h1 class="text-2xl font-bold text-center">Welcome to MHenriquez</h1>
            <!-- Tarjetas -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                ...
                <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Connect with {{ $provider->name }} provider.</p>
